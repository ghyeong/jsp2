...
function check(){
	...
	<form action="signin.user" method="post" onsubmit="return chekck()">
		<table border="1">
			<tr>
			...
			<tr>
				<td>비밀번호</td>
				<td><input type="password" name="pwd" id="pwd"value="<%=user.get("id") %>"></td>
			</tr>
			<tr>
				<td>이름</td>
				<td><input type="text" name="name" id="name" value= "<%=user.get("id") %>"></td>
			</tr>
			<tr>
				<td>취미</td>
				<td>
		...
		<input type="hidden" name="command" value="uadate">
